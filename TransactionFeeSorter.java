...
public class TransactionFeeSorter {
    ...
    static List<Transaction> highFeeOutliers(List<Transaction> list) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Bubble Sort (fee asc): " + bubbleList);
        ...
        List<Transaction> outliers = highFeeOutliers(transactions);
